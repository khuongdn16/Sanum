...
const Profile = () => {
  ...
  let statusMessage = '';
  const stats = totalIntake - caloriesBurnt;
  if (stats < goal) {
    statusMessage = 'You achieved your weekly goal!';
  } else {
    statusMessage = `You have ${Math.abs(goal - stats)} calories to go!`;
  }
  ...
  return (
    <div className="profile-container">
      ...
      <div className="profile-box">
        <div id="profile">
          <h3>
            First Name: <span style={{ color: 'green' }}>{firstname}</span>
          </h3>
          <h3>
            Last Name: <span style={{ color: 'green' }}>{lastname}</span>
          </h3>
          <h3>
          ...
          <div id="page-center">
            <div>
              ...
              />
              <button id="add-goal" className="btn btn-secondary" onClick={updateGoal}>
                Confirm
              </button>
            </div>
          </div>
          <div>
            <h3>
              Current Goal: <span style={{ color: 'green' }}>{goal}</span>
            </h3>
            <h3>
              Burnt Calories: <span style={{ color: 'green' }}>{caloriesBurnt}</span>
            </h3>
            <h3>
              {' '}
              Calorie Intake: <span style={{ color: 'green' }}>{totalIntake}</span>
            </h3>
          </div>
          <div id="encourage">
            <br />
            ...
            <br />
            <h1>
              <span style={{ color: 'green' }}>Keep Up The Good Work!</span>
            </h1>
          </div>
        </div>
        {/* </div> */}
